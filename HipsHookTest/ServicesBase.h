...
class ServicesTestObject : public ServiceBase {
public:
    ServicesTestObject(const ServicesTestObject& other) = delete;
    ServicesTestObject& operator=(const ServicesTestObject& other) = delete;

    ServicesTestObject(ServicesTestObject&& other) = delete;
    ServicesTestObject& operator=(ServicesTestObject&& other) = delete;

    ServicesTestObject()
        : ServiceBase(_T("HookServicesTest"),
            _T("hook services test"),
